...
;-
pro jhusdss_write_allqsospec_new_Weirong, nmfver, boss=boss, overwrite=overwrite
...
outfile = qsopath+'/Temp/'+jhusdss_allqsospec_filename(nmfver, boss=boss)

flux_outfile = repstr(outfile, '.fits', '_flux_Weirong.fits')
cont_outfile = repstr(outfile, '.fits', '_continuum_Weirong.fits')
normresi_outfile = repstr(outfile, '.fits', '_normalized_residual_Weirong.fits')
subtresi_outfile = repstr(outfile, '.fits', '_subtracted_residual_Weirong.fits')
...
qso_file = getenv('ALL_DATA')+'/Masha/Weirong/spectralist.fits'
stats_file = getenv('ALL_DATA')+'/Masha/Weirong/spectralist_stats.fits'

qso = mrdfits(qso_file,1)
stats = mrdfits(stats_file,1)
nqso = n_elements(qso)
