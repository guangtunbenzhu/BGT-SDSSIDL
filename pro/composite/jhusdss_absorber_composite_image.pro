pro jhusdss_absorber_composite_image, nmfver, boss=boss, overwrite=overwrite, nsam=nsam
...
resifile = path+'/'+jhusdss_absorber_composite_image_filename(nmfver, boss=boss)
...
;absorbers = mrdfits('~/SDATA/SDSS/CIV/sdss_civ_cookseyetal13_withqsoindex.fits', 1)
