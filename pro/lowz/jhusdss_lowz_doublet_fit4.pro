...
pro jhusdss_lowz_doublet_line_fit4, quadra, slope, intercept, center, separation, lflux, ratio, sigma, $
...
p=mpfitfun('jhusdss_lowz_doublet_func4', use_lambda, use_flux, use_err, $
...
err_lflux2 = perror[6]
err_sigma = perror[7]
err_ratio = sqrt(err_lflux2^2/lflux^2 + (err_lflux*lflux2/(lflux)^2)^2)

end

pro jhusdss_lowz_doublet_fit4, in_lambda, in_flux, in_ivar, $
...
jhusdss_lowz_doublet_line_fit4, quadra, slope, intercept, center, separation, lflux, ratio, sigma, $
        err_quadra, err_slope, err_intercept, err_center, err_separation, err_lflux, err_ratio, err_sigma
