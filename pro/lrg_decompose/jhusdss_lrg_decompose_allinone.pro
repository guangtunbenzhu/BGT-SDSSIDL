...
;-
pro jhusdss_lrg_decompose_allinone, nmfver, overwrite=overwrite, $
       boss=boss
...
flux_file = path+'/'+jhusdss_lrg_decompose_allinone_filename(nmfver, boss=boss, /flux)
cont_file = path+'/'+jhusdss_lrg_decompose_allinone_filename(nmfver, boss=boss, /continuum)
residual_file = path+'/'+jhusdss_lrg_decompose_allinone_filename(nmfver, boss=boss, /residual)
...
;for i=0L, nspec-1L do begin
 for i=0L, nspec-1L do begin
    counter, i+1, nspec
    spec = jhusdss_lrg_decompose_loadspec(objs0[i].plate, objs0[i].fiber, objs0[i].mjd, $
                   nmfver, boss=boss, error=error)
