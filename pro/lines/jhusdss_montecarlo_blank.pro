function jhusdss_montecarlo_blank, nz
...
strtmp = {plate:0L, fiber:0L, zgrid:fltarr(nz), $
          isitcovered:bytarr(nz), isitdetected:bytarr(nz), $
          rew_mgii_2796:fltarr(nz), rew_mgii_2803:fltarr(nz), $
          signal_mgii_2796:fltarr(nz), signal_mgii_2803:fltarr(nz)}
