;+
; Still training
; 01/19/2012 -- move to convolved spectra
;-
...
donespec = jhusdss_convolve_donespec(nmfver, boss=boss)
...
nabs = 0L
nabsall = 0L
for itest=0L, nspec-1L do begin

   counter, itest+1, nspec
   spec = jhusdss_convolve_loadspec(donespec[itest].plate, donespec[itest].fiber, nmfver, boss=boss)
   absorbers0 = jhusdss_detect_absorbers_newengine(spec, lines=lines, emlines=emlines, nabsmax=nabsmax)
