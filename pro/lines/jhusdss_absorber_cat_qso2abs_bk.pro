function jhusdss_absorber_cat_qso2abs, qso0
...
for i=0L, nqso-1L do begin
    for j=0L, qso[i].nabs-1L do begin
        ...
        absorbers[iabs].zqso = qso[i].zqso
        absorbers[iabs].err_zqso = qso[i].err_zqso
        absorbers[iabs].spec_snr_median = qso[i].spec_snr_median
        ...
        absorbers[iabs].criterion_mgii = qso[i].magic[0,j]
        absorbers[iabs].criterion_feii = qso[i].magic[2,j]
