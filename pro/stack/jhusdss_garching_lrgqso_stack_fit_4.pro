...
outfile = repstr(infile, '.fits', '_fit_samesigma_4.fits')
...
for irp=0L, nrp-1L do begin
    ...
    for iter=0,1 do begin
        jhusdss_lowz_doublet_fit4, wave[iuse], 1.-y[iuse], fltarr(nuse)+1./terror^2, $
...
;   stop
    ...
    for imc=0L, nmc-1L do begin
        ...
        jhusdss_lowz_doublet_fit4, wave[iuse], 1.-newy[iuse], fltarr(nuse)+1./terror^2, $
    ...
    ;; QAplots
    load_dp, /b
    print, 'vdisp: ', outstr[irp].sigma, outstr[irp].err_sigma
