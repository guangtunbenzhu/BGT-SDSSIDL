...
infile = repstr(infile, '.fits', '_bootstrap.fits')
...
outfile = repstr(infile, '.fits', '_fit_samesigma.fits')
outfile_err = repstr(infile, '.fits', '_fit_samesigma_moment.fits')
...
outstr = replicate({rp:0., ew:fltarr(nbootstrap), err_ew:fltarr(nbootstrap), sigma:fltarr(nbootstrap), err_sigma:fltarr(nbootstrap), $
            line_ratio:fltarr(nbootstrap), err_line_ratio:fltarr(nbootstrap), $
;           wave_mc:mc_line_wave, ew_mc:fltarr(nmc)-10fltarr(nbootstrap), sigma_mc:fltarr(nmc)-10fltarr(nbootstrap), line_ratio_mc:fltarr(nmc)-10fltarr(nbootstrap), sdev_mc:-10fltarr(nbootstrap), sdev_sigma_mc:-10fltarr(nbootstrap), $
            ew_nofit:fltarr(nbootstrap), err_ew_nofit:fltarr(nbootstrap), $ ;ew_nofit_mc:fltarr(nmc)-10fltarr(nbootstrap), sdev_nofit_mc:-10fltarr(nbootstrap), $
            ew_nofit_2:fltarr(nbootstrap), err_ew_nofit_2:fltarr(nbootstrap), $ ;ew_nofit_2_mc:fltarr(nmc)-10fltarr(nbootstrap), sdev_nofit_2_mc:-10fltarr(nbootstrap), $
            ew_nofit_lr_1:fltarr(nbootstrap), err_ew_nofit_lr_1:fltarr(nbootstrap), $ ;ew_nofit_lr_1_mc:fltarr(nmc)-10fltarr(nbootstrap), sdev_nofit_lr_1_mc:-10fltarr(nbootstrap), $
            ew_nofit_s4:fltarr(nbootstrap), err_ew_nofit_s4:fltarr(nbootstrap), $ ;ew_nofit_s4_mc:fltarr(nmc)-10fltarr(nbootstrap), sdev_nofit_s4_mc:-10fltarr(nbootstrap), $
            ew_nofit_2_s4:fltarr(nbootstrap), err_ew_nofit_2_s4:fltarr(nbootstrap), $ ;ew_nofit_2_s4_mc:fltarr(nmc)-10fltarr(nbootstrap), sdev_nofit_2_s4_mc:-10fltarr(nbootstrap), $
            ew_nofit_lr_1_s4:fltarr(nbootstrap), err_ew_nofit_lr_1_s4:fltarr(nbootstrap), $ ;ew_nofit_lr_1_s4_mc:fltarr(nmc)-10fltarr(nbootstrap), sdev_nofit_lr_1_s4_mc:-10fltarr(nbootstrap), $
            ew_nofit_s5:fltarr(nbootstrap), err_ew_nofit_s5:fltarr(nbootstrap), $ ;ew_nofit_s5_mc:fltarr(nmc)-10fltarr(nbootstrap), sdev_nofit_s5_mc:-10fltarr(nbootstrap), $
            ew_nofit_2_s5:fltarr(nbootstrap), err_ew_nofit_2_s5:fltarr(nbootstrap),$ ; ew_nofit_2_s5_mc:fltarr(nmc)-10fltarr(nbootstrap), sdev_nofit_2_s5_mc:-10fltarr(nbootstrap), $
            ew_nofit_lr_1_s5:fltarr(nbootstrap), err_ew_nofit_lr_1_s5:fltarr(nbootstrap) $ ;ew_nofit_lr_1_s5_mc:fltarr(nmc)-10fltarr(nbootstrap), sdev_nofit_lr_1_s5_mc:-10fltarr(nbootstrap) $
            }, nrp)
...
for irp=0L, nrp-1L do begin
    ...
    for iboot=0L, nbootstrap-1L do begin
    counter, iboot+1, nbootstrap

    y = comp[irp].fluxgeomean[*,iboot]/comp_shuffle[irp].fluxgeomean
...
;   y = (y/med_continuum)
    ...
    outstr[irp].ew[iboot] = lflux
    outstr[irp].err_ew[iboot] = err_lflux
    outstr[irp].sigma[iboot] = sigma
    outstr[irp].err_sigma[iboot] = err_sigma
    outstr[irp].line_ratio[iboot] = 1./ratio
    outstr[irp].err_line_ratio[iboot] = err_ratio/ratio
    ...
    jhusdss_singlet_smooth, 1.-newy, fltarr(n_elements(y))+1./terror^2, $
       outflux=single_newy_s5, outivar=single_newyivar_s5, sigma=6., /normalize, factor_norm=factor_norm1_s5
    jhusdss_doublet_smooth, 1.-newy, fltarr(n_elements(y))+1./terror^2, $
       outflux=double_newy_s5, outivar=double_newyivar_s5, sigma=6., /normalize, factor_norm=factor_norm2_s5, separation=fix_separation, line_ratio=2.
    jhusdss_doublet_smooth, 1.-newy, fltarr(n_elements(y))+1./terror^2, $
       outflux=double_newy_1_s5, outivar=double_newyivar_1_s5, sigma=6., /normalize, factor_norm=factor_norm2_1_s5, separation=fix_separation, line_ratio=1.

    outstr[irp].ew_nofit[iboot] = single_newy[icaii]*(wave[icaii]-wave[icaii-1])/factor_norm1
    outstr[irp].err_ew_nofit[iboot] = 1./sqrt(single_newyivar[icaii])*(wave[icaii]-wave[icaii-1])/factor_norm1
    outstr[irp].ew_nofit_2[iboot] = double_newy[icaii]*(wave[icaii]-wave[icaii-1])/factor_norm2*2./3.
    outstr[irp].err_ew_nofit_2[iboot] = 1./sqrt(double_newyivar[icaii])*(wave[icaii]-wave[icaii-1])/factor_norm2*2./3.
    outstr[irp].ew_nofit_lr_1[iboot] = double_newy_1[icaii]*(wave[icaii]-wave[icaii-1])/factor_norm2_1*2./4.
    outstr[irp].err_ew_nofit_lr_1[iboot] = 1./sqrt(double_newyivar_1[icaii])*(wave[icaii]-wave[icaii-1])/factor_norm2_1*2./4.

    outstr[irp].ew_nofit_s4[iboot] = single_newy_s4[icaii]*(wave[icaii]-wave[icaii-1])/factor_norm1_s4
    outstr[irp].err_ew_nofit_s4[iboot] = 1./sqrt(single_newyivar_s4[icaii])*(wave[icaii]-wave[icaii-1])/factor_norm1_s4
    outstr[irp].ew_nofit_2_s4[iboot] = double_newy_s4[icaii]*(wave[icaii]-wave[icaii-1])/factor_norm2_s4*2./3.
    outstr[irp].err_ew_nofit_2_s4[iboot] = 1./sqrt(double_newyivar_s4[icaii])*(wave[icaii]-wave[icaii-1])/factor_norm2_s4*2./3.
    outstr[irp].ew_nofit_lr_1_s4[iboot] = double_newy_1_s4[icaii]*(wave[icaii]-wave[icaii-1])/factor_norm2_1_s4*2./4.
    outstr[irp].err_ew_nofit_lr_1_s4[iboot] = 1./sqrt(double_newyivar_1_s4[icaii])*(wave[icaii]-wave[icaii-1])/factor_norm2_1_s4*2./4.

    outstr[irp].ew_nofit_s5[iboot] = single_newy_s5[icaii]*(wave[icaii]-wave[icaii-1])/factor_norm1_s5
    outstr[irp].err_ew_nofit_s5[iboot] = 1./sqrt(single_newyivar_s5[icaii])*(wave[icaii]-wave[icaii-1])/factor_norm1_s5
    outstr[irp].ew_nofit_2_s5[iboot] = double_newy_s5[icaii]*(wave[icaii]-wave[icaii-1])/factor_norm2_s5*2./3.
    outstr[irp].err_ew_nofit_2_s5[iboot] = 1./sqrt(double_newyivar_s5[icaii])*(wave[icaii]-wave[icaii-1])/factor_norm2_s5*2./3.
    outstr[irp].ew_nofit_lr_1_s5[iboot] = double_newy_1_s5[icaii]*(wave[icaii]-wave[icaii-1])/factor_norm2_1_s5*2./4.
    outstr[irp].err_ew_nofit_lr_1_s5[iboot] = 1./sqrt(double_newyivar_1_s5[icaii])*(wave[icaii]-wave[icaii-1])/factor_norm2_1_s5*2./4.

;   stop

    if (keyword_set(doMC)) then begin
...
;   mcmom_ew_nofit_lr_1_s5 = moment(outstr[irp].ew_nofit_lr_1_s5_mc[iusemc], sdev=nofit_lr_1_s5_mcsdev)
    ...
    ;; QAplots
    load_dp, /b
    print, 'vdisp: ', outstr[irp].sigma1[10], outstr[irp].err_sigma1[10], outstr[irp].sigma2[10], outstr[irp].err_sigma2[10]
    print, 'line_ratio: ', outstr[irp].line_ratio[10], outstr[irp].err_line_ratio[10]
...
;   djs_oplot, outstr[irp].ew*[1,1], !y.crange, linestyle=0, thick=15., color='red'
    print, 'rp, ew, sdev, ew_nofit, ew_nofit_2', outstr[irp].rp, outstr[irp].ew[10], outstr[irp].ew_nofit[10], outstr[irp].ew_nofit_2[10]
    print, 'vdisp: ', outstr[irp].sigma[10]
    endif

    endfor ;; nbootstrap
    print, mean(outstr[irp].ew), mean(outstr[irp].ew_nofit_2_s4), mean(outstr[irp].ew_nofit_lr_1_s5)
    print, sqrt((moment(outstr[irp].ew))[1]), sqrt((moment(outstr[irp].ew_nofit_2_s4))[1]), sqrt((moment(outstr[irp].ew_nofit_lr_1_s5))[1])

endfor ;; nrp

mwrfits, outstr, outfile, /create

ew_err = moment(outstr.ew*(1./outstr.line_ratio+1.), dimension=1, sdev=ew_sdev)
sigma_err = moment(outstr.sigma, dimension=1, sdev=sigma_sdev)
outstr_err = replicate({rp:0., ew:0., err_ew:0., sigma:0., err_sigma:0.}, nrp)
outstr_err.rp = outstr.rp
outstr_err.ew = ew_err[*,0]
outstr_err.err_ew = ew_sdev
outstr_err.sigma = sigma_err[*,0]
outstr_err.err_sigma = sigma_sdev

mwrfits, outstr_err, outfile_err, /create
