...
infile = repstr(infile, '.fits', '_zmin'+string(zgalmin, format='(f4.2)')+'_zmax'+string(zgalmax, format='(f4.2)')+'.fits')
...
profile_slope = -1.5038274
profile_intercept = 0.88128106
...
oploterror, outstr.rp, outstr.ew_nofit_2, outstr.sdev_nofit_2_mc, psym=5, color=djs_icolor('red'), errcolor=djs_icolor('red')
