...
if (quiescent) then outfile = repstr(outfile, '.fits', '_quiescent.fits') else outfile = repstr(outfile, '.fits', '_sf.fits')
...
for irad=0L, nrp-1L do begin
    ...
    if (~quiescent) then mass_sep=10.1 else mass_sep=10.7

    if (~massive) then begin
       ;; low-mass sfr; lt and gt
       if (~quiescent) then begin
             ...
             ;; lt and gt
             and mass_tmp lt mass_sep and sfr_tmp gt -1.29+0.65*(mass_tmp-10.)+0.5) $
             and zuniq $
       ...
       if (quiescent) then begin
             ...
             and (mass_tmp gt 7. and mass_tmp lt 13. and sfr_tmp gt -3. and sfr_tmp lt 3. $ 
             ;; lt and lt
             and mass_tmp lt mass_sep and sfr_tmp lt -1.29+0.65*(mass_tmp-10.)+0.5) $
             and zuniq $
             and ((2830.*(zqso+1.) lt (line_wave[0]-5.)*(1.+zgal) and 3920.*(zqso+1.) gt (line_wave[1]+5.)*(1.+zgal) and sdev_red_tmp lt 0.1) $
              or  (1930.*(zqso+1.) lt (line_wave[0]-5.)*(1.+zgal) and 2770.*(zqso+1.) gt (line_wave[1]+5.)*(1.+zgal) and sdev_red_tmp lt 0.1) $
              or  (1580.*(zqso+1.) lt (line_wave[0]-5.)*(1.+zgal) and 1870.*(zqso+1.) gt (line_wave[1]+5.)*(1.+zgal) and sdev_red_tmp lt 0.1) $
    ...
    if (massive) then begin
       ;; high-mass sfr; gt and gt
       if (~quiescent) then begin
             iall = where((zgal gt zgalmin) and (zgal lt zgalmax) $
             and ((zgal gt (wave_exclude+15.)/(line_wave[0]-0.)-1.) or (zgal lt (wave_exclude-15.)/(line_wave[1]+0.)-1.)) $
             and (snr_tmp gt snrcut) $
             and (mass_tmp gt 7. and mass_tmp lt 12. and sfr_tmp gt -3. and sfr_tmp lt 3. $ 
             ;; gt and gt
             and mass_tmp gt mass_sep and sfr_tmp gt -1.29+0.65*(mass_tmp-10.)+0.5) $
             and zuniq $
             and ((2830.*(zqso+1.) lt (line_wave[0]-5.)*(1.+zgal) and 3920.*(zqso+1.) gt (line_wave[1]+5.)*(1.+zgal) and sdev_red_tmp lt 0.1) $
              or  (1930.*(zqso+1.) lt (line_wave[0]-5.)*(1.+zgal) and 2770.*(zqso+1.) gt (line_wave[1]+5.)*(1.+zgal) and sdev_red_tmp lt 0.1) $
              or  (1580.*(zqso+1.) lt (line_wave[0]-5.)*(1.+zgal) and 1870.*(zqso+1.) gt (line_wave[1]+5.)*(1.+zgal) and sdev_red_tmp lt 0.1) $
       ...
       if (quiescent) then begin
             ...
             and (mass_tmp gt 7. and mass_tmp lt 12. and sfr_tmp gt -3. and sfr_tmp lt 3. $ 
             ;; gt and lt
             and mass_tmp gt mass_sep and sfr_tmp lt -1.29+0.65*(mass_tmp-10.)+0.5) $
             and zuniq $
             and ((2830.*(zqso+1.) lt (line_wave[0]-5.)*(1.+zgal) and 3920.*(zqso+1.) gt (line_wave[1]+5.)*(1.+zgal) and sdev_red_tmp lt 0.1) $
              or  (1930.*(zqso+1.) lt (line_wave[0]-5.)*(1.+zgal) and 2770.*(zqso+1.) gt (line_wave[1]+5.)*(1.+zgal) and sdev_red_tmp lt 0.1) $
              or  (1580.*(zqso+1.) lt (line_wave[0]-5.)*(1.+zgal) and 1870.*(zqso+1.) gt (line_wave[1]+5.)*(1.+zgal) and sdev_red_tmp lt 0.1) $
