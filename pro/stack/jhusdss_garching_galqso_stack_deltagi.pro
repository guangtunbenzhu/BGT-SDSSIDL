...
;   delta_gi_tmp = qso_gi[match.index_qso].delta_g_i
...
djs_plot, outstr.rp, outstr.delta_gi_mean-0.033, /xlog, /ylog, yra=[1E-5, 5E-1], yst=1, psym=4, thick=3

k_print, filename='delta_gi.ps', axis_char_scale=1.3, xsize=8, ysize=6
  djs_plot, outstr.rp, outstr.delta_gi_mean-0.033, /xlog, /ylog, yra=[1E-4, 2E-1], yst=1, psym=4, symsize=1.5, thick=6, $
      xthick=6, ythick=6, xtitle='r_p (kpc)', ytitle='<\Delta g-i>', charsize=1.5, charthick=3, color='red', xra=[5, 3000], xst=1, $
