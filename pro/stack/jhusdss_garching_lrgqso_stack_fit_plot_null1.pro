...
psfile1 = repstr(infile, '.fits', '_null_1.ps')
psfile2 = repstr(infile, '.fits', '_null_2.ps')
psfile3 = repstr(infile, '.fits', '_null_3.ps')
psfile4 = repstr(infile, '.fits', '_null_4.ps')
psfile5 = repstr(infile, '.fits', '_null_5.ps')
psfile6 = repstr(infile, '.fits', '_null_6.ps')

;; manually check, independent binsl
...
nran = 12
iran = ((long(randomu(seed, 40)*180+10) > 0) < 200)
isort = bsort(iran)
iran = iran[isort[uniq(isort)]]
iran = iran[lindgen(nran)*3+1]
;print, a[0].wave_mc[iran]
iran = [13,19,34,40,55,65,87,111,141,149,164,177]
print, iran
...
;         psym=8, symsize=1.5, color=djs_icolor('red'), thick=thick, errcolor=djs_icolor('red'), errthick=thick
      polyfill, [xra, reverse(xra)], [1,1,-1,-1], color=djs_icolor('light gray')
      djs_oplot, a[i_indep].rp, a[i_indep].ew_nofit_mc[iran[i]]/a[i_indep].sdev_nofit_mc, psym=5, symsize=1.2, thick=thick, color='dark gray'
      djs_oplot, a[i_indep].rp, a[i_indep].ew_nofit/a[i_indep].sdev_nofit_mc, psym=8, symsize=1.6, thick=thick, color='red'
      ...
      if (i eq 2) then legend, [textoidl('Measurement at \lambda=3934 (Ca II)'), textoidl('Null test at random \lambda')], $
         psym=[8,4], colors=[djs_icolor('red'), djs_icolor('dark gray')], thick=8, charsize=1.3, charthick=charthick, $
         /top, /right, box=0, textcolors=[djs_icolor('red'), djs_icolor('dark gray')], pos=[2600,7.9]
;     djs_xyouts, 100, 5, $
;         '\lambda='+string(a[0].wave_mc[iran[i]], format='(i4.4)')+' \AA', $
;         charsize=charsize-0.5, charthick=charthick, color='dark gray'
  endfor
k_end_print

if (keyword_set(plotall)) then begin
k_print, filename=psfile2, axis_char_scale=1.3, xsize=8, ysize=6
  djs_plot, a.rp, a.ew_mc[iran], xtitle=xtitle, ytitle=ytitle, title=title, $
      xra=xra, yra=yra, xst=1, yst=1, thick=thick, xthick=xthick, ythick=ythick, $
      charsize=charsize, charthick=charthick, /nodata, /xlog, pos=pos
  ibegin=1
  iend=23 
...
; !p.multi=[0,3,4]
  ...
  for i=0,11 do begin
      ...
      djs_oplot, a[i_indep].rp/1E3, a[i_indep].ew_nofit_lr_1_s5_mc[iran[i]]/a[i_indep].sdev_nofit_lr_1_s5_mc, psym=symcat(14), symsize=1.8, thick=thick, color=zcolor[i]
      djs_oplot, a[i_indep].rp/1E3, a[i_indep].ew_nofit_lr_1_s5_mc[iran[i]]/a[i_indep].sdev_nofit_lr_1_s5_mc, thick=10, color=zcolor[i]
;     djs_oplot, a[i_indep].rp/1E3, a[i_indep].ew_nofit_2_s4_mc[iran[i]]/a[i_indep].sdev_nofit_2_s4_mc/bootstrap_corr[i_indep], psym=symcat(14), symsize=1.8, thick=thick, color=zcolor[i]
;     djs_oplot, a[i_indep].rp/1E3, a[i_indep].ew_nofit_2_s4_mc[iran[i]]/a[i_indep].sdev_nofit_2_s4_mc/bootstrap_corr[i_indep], thick=10, color=zcolor[i]
;     djs_oplot, a[i_indep].rp/1E3, a[i_indep].ew_mc[iran[i]]/a[i_indep].sdev_nofit_2_s4_mc/1.5/bootstrap_corr[i_indep], psym=symcat(14), symsize=1.8, thick=thick, color=zcolor[i]
;     djs_oplot, a[i_indep].rp/1E3, a[i_indep].ew_mc[iran[i]]/a[i_indep].sdev_nofit_2_s4_mc/1.5/bootstrap_corr[i_indep], thick=10, color=zcolor[i]
;     djs_oplot, a[i_indep].rp/1E3, a[i_indep].ew_mc[iran[i]]/a[i_indep].sdev_mc, psym=symcat(14), symsize=1.8, thick=thick, color=zcolor[i]
;     djs_oplot, a[i_indep].rp/1E3, a[i_indep].ew_mc[iran[i]]/a[i_indep].sdev_mc, thick=10, color=zcolor[i]
      djs_oplot, xra, [0, 0], color='grey'
...
;     if (i ge 9) then djs_axis, xaxis=0, xtitle=xtitle, charsize=charsize, charthick=charthick
      if (i eq 2) then legend, [textoidl('Measurement at \lambda(Mg II)'), textoidl('Null tests at random \lambda')], $
...
; djs_oplot, a[i_indep].rp/1E3, a[i_indep].ew*(1.+1./a[i_indep].line_ratio)/a[i_indep].sdev_mc, psym=8, symsize=3, thick=thick, color='blue'
; djs_oplot, a[i_indep].rp/1E3, a[i_indep].ew*(1.+1./a[i_indep].line_ratio)/a[i_indep].sdev_mc, thick=10, color='blue'
...
;     plotsym, 8, /fill
      djs_oplot, a[i_indep].rp, a[i_indep].ew_nofit_2_mc[iran[i]]/a[i_indep].sdev_nofit_2_mc, psym=symcat(14), symsize=1.6, thick=thick, color='dark gray'
      djs_oplot, a[i_indep].rp, a[i_indep].ew_nofit_2_mc[iran[i]]/a[i_indep].sdev_nofit_2_mc, thick=10, color='dark gray'
      djs_oplot, xra, [0, 0], color='grey'
      if (i mod 3 eq 0) then djs_axis, yaxis=0, ytitle=ytitle, charsize=charsize, charthick=charthick
      if (i ge 9) then djs_axis, xaxis=0, xtitle=xtitle, charsize=charsize, charthick=charthick
      if (i eq 2) then legend, [textoidl('Measurement at \lambda=3934 (Ca II)'), textoidl('Null tests at random \lambda')], $
...
k_print, filename=psfile5, axis_char_scale=1.6, xsize=8, ysize=8
  ...
  for i=0,8 do begin
      ...
      djs_oplot, a[i_indep].rp, a[i_indep].ew_nofit_2_mc[iran[i]], psym=symcat(14), symsize=2.0, thick=thick, color='dark gray'
      djs_oplot, a[i_indep].rp, a[i_indep].ew_nofit_2_mc[iran[i]], thick=10, color='dark gray'
      djs_oplot, xra, [0, 0], color='grey'
      if (i eq 0 or i eq 3 or i eq 6) then djs_axis, yaxis=0, ytitle=ytitle, charsize=charsize, charthick=charthick
      if (i eq 6 or i eq 7 or i eq 8) then djs_axis, xaxis=0, xtitle=xtitle, charsize=charsize, charthick=charthick
      if (i eq 2) then legend, [textoidl('Measurement at \lambda=3934 (Ca II)'), textoidl('Null test at random \lambda')], $
