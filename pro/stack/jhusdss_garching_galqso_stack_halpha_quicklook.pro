...
;minrad = [0.03, 0.10, 0.20, 0.25, 0.184, 0.30, 0.45, 0.0.010, 0.050, 0.100, 0.120, 0.150, 0.170];, 0.180];, 0.200];, 0.170, 0.180];, 0.150]
;maxrad = [0.10, 0.20, 0.30, 0.0.45, 0.675, 0.100, 0.200, 0.240, 0.300, 0.340];, 0.360];, 0.400];, 0.340, 0.360];, 0.300]

minrad_tmp = 10.^(alog10(0.020)+findgen(24)*(0.5*alog10(1.5)))
