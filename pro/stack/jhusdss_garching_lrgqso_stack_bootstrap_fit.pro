...
outstr = replicate({rp:0., ew:fltarr(nbootstrap), err_ew:fltarr(nbootstrap), sigma1:fltarr(nbootstrap), err_sigma1:fltarr(nbootstrap), $
            sigma2:fltarr(nbootstrap), err_sigma2:fltarr(nbootstrap), line_ratio:fltarr(nbootstrap), err_line_ratio:fltarr(nbootstrap), $
...
;   y = (y/med_continuum)
    ...
    outstr[irp].sigma1[iboot] = sigma1
    outstr[irp].err_sigma1[iboot] = err_sigma1
    outstr[irp].sigma2[iboot] = sigma2
    outstr[irp].err_sigma2[iboot] = err_sigma2
...
;   djs_oplot, outstr[irp].ew*[1,1], !y.crange, linestyle=0, thick=15., color='red'
    ...
    print, 'vdisp: ', outstr[irp].sigma1[10], outstr[irp].sigma2[10]
    endif
