...
profile_slope = -1.38
profile_intercept = alog10(1.0E-2)
yy = profile_slope*(xx-2.)+profile_intercept
djs_plot, outstr[i_indep].rp, outstr[i_indep].ew_nofit_2, psym=4, xra=[5,2000], yra=[1E-4, 1E0], /xlog, /ylog, xst=1, yst=1
;djs_plot, outstr.rp, outstr.ew_nofit_2, psym=4, xra=[200,2000], yra=[-5E-3, 5E-3], /xlog, xst=1, yst=1
oploterror, outstr[i_indep].rp, outstr[i_indep].ew_nofit_2, outstr.sdev_nofit_2_mc, psym=5, color=djs_icolor('blue'), errcolor=djs_icolor('blue')
;oploterror, a.rp, a.ew_nofit_2, a.sdev_nofit_2_mc, psym=5, color=djs_icolor('red'), errcolor=djs_icolor('red')
djs_oplot, 10.^xx, 10.^yy
djs_oplot, outstr[i_indep].rp, outstr[i_indep].sdev_nofit_2_mc, color='blue'
