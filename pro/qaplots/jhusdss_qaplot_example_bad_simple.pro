pro jhusdss_qaplot_example_bad_simple, nmfver, choose=choose
...
psfile = qapath+'/'+'JHU_examples_bad_simple_'+string(nmfver, format='(I3.3)')+'.ps'
...
;   yresi = spec.residual
    ...
    djs_oplot, x[ii], ynmf[ii]*ymed[ii], color='red', thick=thick
