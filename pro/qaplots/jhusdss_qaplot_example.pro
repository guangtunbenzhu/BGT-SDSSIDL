pro jhusdss_qaplot_example, nmfver, choose=choose

linename=['Mg_{ }I', 'Mg_{ }II', 'Fe_{ }II', 'Fe_{ }II', 'Al_{ }II', 'C_{ }IV', 'Si_{ }II', 'Si_{ }IV', 'C_{ }II', 'O_{ }I'] 
...
ichoose1 = -1L
colors = ['dark green', 'yellow', 'green']
...
psfile = qapath+'/'+'JHU_examples_'+string(nmfver, format='(I3.3)')+'.ps'
...
;   ymed = smooth(spec.med_continuum, 5)
    ...
    djs_oplot, x[jj], ynmf[jj], color='blue', thick=thick, linestyle=2
    djs_oplot, x[jj], ynmf[jj]*ymed[jj], color='red', thick=3
...
;       linestyle=[0,0], thick=thick, pspacing=1.6
    ...
    legend, items, textcolor=colors, colors=colors, $
        box=0, /right, /top, charsize=charsize, charthick=charthick, $
        linestyle=[0,2], thick=thick, pspacing=1.6, pos=[9300., 4.0]
