pro jhusdss_qaplot_stats, nmfver, train=train

qso = jhusdss_absorber_readin(nmfver, train=train)
qso_trim = jhusdss_absorber_readin(nmfver, train=train, /trim)

absorber = jhusdss_absorber_readin(nmfver, train=train, /byabs, /trim)
absorber_feii = jhusdss_absorber_readin(nmfver, train=train, /byabs, /trim, /feii)
absorber_asso = jhusdss_absorber_readin(nmfver, train=train, /byabs, /trim, /keepasso)
